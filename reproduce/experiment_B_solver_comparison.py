                    ...
                    metrics.update(
                        {
                            ...
                            "summary_objective_value": result.get("metrics", {}).get("summary_objective_value"),
                            ...
                            "time_limit_feasible": result.get("metrics", {}).get("time_limit_feasible", False),
                            "time_limit_no_solution": result.get("metrics", {}).get("time_limit_no_solution", False),
                            "model_build_error": result.get("metrics", {}).get("model_build_error", False),
