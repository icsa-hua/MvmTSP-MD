...
class EnvSim:
    ...
    def optimization_process(self, constructor:object, data:pd.DataFrame):
        constructor.run_model(data)
    ...
    def simulations(self, constructor:object, cues:object, data:pd.DataFrame, trials:int=3000):
        self.env.process(self.optimization_process(constructor, data))
